      ...
      <section className="bg-gradient-to-r from-blue-50 to-blue-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Ready to start your solar journey? Contact our experts for a free consultation and custom quote
          </p>
        </div>
      </section>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        ...
                        placeholder="Tell us about your solar energy needs, property size, current energy usage, or any questions you have..."
                      />
                    </div>
                  </div>
